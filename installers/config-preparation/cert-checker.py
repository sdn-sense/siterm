...
def printInfo(inDict):
    ...
    print("-" * 80)
    print(
        "INFO: Please ensure that Certificate full DN is entered in GIT Repo for the Frontend."
    )
    print(
        "INFO: In case it is custom certificate, you will need to put ca in Fronend to trust local issued certificate"
    )
    print("-" * 80)
